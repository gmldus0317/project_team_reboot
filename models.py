...
class MenuCoffee(Base):
    __tablename__="menu_coffee"
...
class MenuDrink(Base):
    __tablename__="menu_drink"
...
class MenuDessert(Base):
    __tablename__="menu_dessert"
